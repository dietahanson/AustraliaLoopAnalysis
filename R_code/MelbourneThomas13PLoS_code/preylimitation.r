...
## Read specification
edges <- model.dia("preylimitation.dia")
...
## Enforce ordering
entity <- match(entity,c("Warming","Sea ice","Krill fishery","Krill","Fish",
...
barplot(t(prop[order(entity),]),
        horiz=T,las=1,cex.names=1.2,cex.axis=1.2,cex.lab=1.2,border=F,col=pal,xlab="Proportion")
par(opar)
